...
TMPDIR=`pwd`/tmp-proj-2
rm -r $TMPDIR
mkdir $TMPDIR

# Set useful variables
PROJECT_NAME="myproj-2"
DATASET_IN_NAME="input-ds-2"
DATASET_OUT_NAME="output-ds-2"
WORKFLOW_NAME="My worfklow 2"
...
echo "{\"parallelization_level\" : \"well\", \"labeling_level\": 4, \"executor\": \"gpu\"}" > ${TMPDIR}/args_labeling.json
