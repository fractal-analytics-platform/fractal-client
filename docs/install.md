...
command line (see its documentation [here](reference/fractal/index.md)).
...
* Explicitly provide `--user` and `--password` arguments for `fractal` commands, see [here](reference/fractal/index.md).
